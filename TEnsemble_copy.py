...
class TEnsemble(TCluster):
    ...
    def run_pipeline(self, model_name_translator, df, batch_size=4, run_dual = True): # do not plat with batch size, collab can not handle it!
        ...
        for word in tqdm(unique_words):
            ...
            subset['predict_sense_id'] = self.cl.agglomerative_clustering_without_norm(combined_vectors)
